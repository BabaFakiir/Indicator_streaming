...
def filter_banknifty_options(
    ...
    strike_min: int = 59500,
    strike_max: int = 62500,
    step: int = 100,
) -> List[Tuple[str, str]]:
    """
...
def main():
    ...
    parser.add_argument("--min", type=int, default=59500, help="Min strike")
    parser.add_argument("--max", type=int, default=62500, help="Max strike")
